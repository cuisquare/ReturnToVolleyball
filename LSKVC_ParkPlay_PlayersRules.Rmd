...
The **Risk Assessment** must be read and understood alongside those rules. The **Club Requirements** should also be read to be aware of the level of support you can expect during a session.
