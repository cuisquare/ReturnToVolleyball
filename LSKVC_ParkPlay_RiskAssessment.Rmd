...
Hazards <- Hazards %>% add_new_hazard(
  ...
  Likelihood_Before = 3,
  Severity_Before = 4,
  Controls = c("Cleaning and wiping down all equipment with sanitiser before and after sessions",
               "Having a limited number of balls to reduce overall risk of transfer"),
  Likelihood_After = 2,
  Severity_After = 3)

Hazards <- Hazards %>% add_new_hazard(
  Hazard="Transfer of virus as a result of increased interaction between athletes including public",
  Persons_Affected = c(
    "Athletes",
    "Public"),
  Likelihood_Before = 3,
  Severity_Before = 4,
  Controls = c(
    "Limit number of people in sessions.",
...
Hazards <- Hazards %>% add_new_hazard(
  Hazard="Increased exposure due to play being scrappier in park compared to game scenario used in Volleyball England to ascertain exposure duration constitutes medium risk",
...
Hazards <- Hazards %>% add_new_hazard(
  Hazard="Transfer of virus from players to general public ",
  Persons_Affected = "Public",
  Likelihood_Before = 3,
  Severity_Before = 4,
  Controls = c(
    "No athlete to take part who has regular contact with at risk population for covid (elderly, underlying health condition)",
    "Social distance at all times when not playing"),
  Likelihood_After = 2,
  Severity_After = 3)
