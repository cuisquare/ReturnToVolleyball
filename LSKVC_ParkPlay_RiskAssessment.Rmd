...
3. Lost time injury, up to and including reportable injury to the HSE with over seven days time lost, but not as a specified injury, Some risk of immediate or long-term health issues. Significant property damage or local environmental damage.
4. Specified injury, long-term absence or significant risk that could lead to immediate or long-term health illness, including reportable disease. Substantial property damage and/or serious environmental impact.
...
## Approach for this Risk Assessment

Hazards are identified and after consideration a Likelihood (L) of occurrence and Severity (S) should they occur is attributed. Controls are put into place resulting in terms of organisation or rules for participants which result in a lower residual Severity and/or Likelihood. Results are summarised in a Risk Assessment Matrix (see below).
