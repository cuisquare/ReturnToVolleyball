...
Hazards are identified and after consideration a Likelihood (L) of occurrence and Severity (S) should they occur is attributed Before and After Controls are put in place. Results are summarised in a Quantitative Risk Assessment Matrix (see below).
