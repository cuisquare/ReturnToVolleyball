...
This Risk Assessment was used to inform the aspects of the **Players Rules** and **Club Requirements** which were specific to our park play activity.
...
kable(x=play_cases_all,format = "latex", booktabs = T, longtable = T,linesep = "",caption="Park Play Configurations - All") %>%
