...
## Prior to Activity:
* Let us know you plan to attend the activity, your contact details and that you opt-in to the present rules and risk assessment and agree with the residual risk involved in the activity. Note that if you have not provided the above information (normally by filling in the form), you will not be able to attend. 
...
* Numbers are capped at *21 players* and numbers will be managed by the session organiser. You will receive confirmation of your spot most likely through a Teamer invite but your individual team might do things differently. Do not come over without that confirmation.
...
* Sanitise hands before handing training equipment for first time.
...
* Social Play. A player can play a maximum of **`r round(get_max_nb_sets_per_player(9,6,20,safety_factor,max_exposure))` sets** total if we play 6v6 (*`r round(get_max_nb_sets_per_player(9,5,20,safety_factor,max_exposure))` sets* total if we play 5v5 and *`r round(get_max_nb_sets_per_player(9,4,20,safety_factor,max_exposure))` sets* total if we play 4v4).
