---
title: "LSKVC Return to Play (Indoor) Club Requirements - Draft"
...
* Numbers of players to be capped at **21 players** as decided by MC 18/08/2020. We should turn down on the day any player turning up putting the total numbers of participants (including those who took part and left) to more than 30. 
...
* Wipe equipment (mainly balls) before and after each set / at each water break
...
* Control the number of sets played by individual players – maximum of **`r round(get_max_nb_sets_per_player(9,6,20,safety_factor,max_exposure))` sets** if we play 6v6 (*`r round(get_max_nb_sets_per_player(9,5,20,safety_factor,max_exposure))` sets* total if we play 5v5 and *`r round(get_max_nb_sets_per_player(9,4,20,safety_factor,max_exposure))` sets* total if we play 4v4).
