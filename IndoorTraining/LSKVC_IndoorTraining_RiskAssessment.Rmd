---
title: "LSKVC Return to Play (Indoor) Risk Assessment - Draft"
...
* Volleyball England Return to Indoor Volleyball Specific Action Plan ([link](https://media.volleyballengland.org/docs/Return%20to%20play%20indoor%20volleyball%20-%20sport%20specific%20action%20plan.pdf))
...
Hazards <- Hazards %>% add_new_hazard(
  ...
  Severity_Before = 5,
  Controls = c(
    "No athlete to take part who is part of at risk population",
...
Hazards <- Hazards %>% add_new_hazard(
  ...
  Severity_Before = 4,
  Controls = c(
    "Limit number of people in session to 16",
