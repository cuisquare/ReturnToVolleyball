...
kable(x=play_cases_6,format = "latex", booktabs = T,linesep = "",caption="Indoor GamePlay Configurations - 12 players") %>%
...
kable(x=play_cases_12,format = "latex", booktabs = T,linesep = "",caption="Indoor GamePlay Configurations - 16 players") %>%
  kable_styling(latex_options = c("striped", "scale_down", "HOLD_position"))%>%
  add_header_above(c(" " = 1, "Inputs" = 7, "Ouputs" = 4)) #%>%  landscape()
